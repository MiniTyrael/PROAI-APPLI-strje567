...
def main():
    ...
    # read the csv files
    df_lastNames, df_firstNames, df_subjects = read_files('02_Data_analysis_and_visuatlizatio/03_DataGeneration/last_names.csv', '02_Data_analysis_and_visuatlizatio/03_DataGeneration/first_names.csv', '02_Data_analysis_and_visuatlizatio/03_DataGeneration/subjects.csv')
